...
class AuthControllerTest {
    ...
    void login_shouldReturnToken() throws Exception {
        ...
        UserResponseDto userDto = new UserResponseDto(1L, "john", "john@test.com", 1, LocalDate.of(2000, 1, 15), null, true);
    ...
    void register_shouldReturn201() throws Exception {
        UserInput input = new UserInput("john", "john@test.com", "password123", 1, LocalDate.of(2000, 1, 15), 175.0);
        UserResponseDto userDto = new UserResponseDto(1L, "john", "john@test.com", 1, LocalDate.of(2000, 1, 15), 175.0, false);
    ...
    void register_shouldReturn400_whenPasswordTooShort() throws Exception {
        UserInput input = new UserInput("john", "john@test.com", "short", 1, LocalDate.of(2000, 1, 15), null);
