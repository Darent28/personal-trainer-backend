...
public class UserService {
    ...
    public UserResponseDto postUser(UserInput userInput) {
        try {
            User user = new User(userInput.getUsername(), userInput.getEmail(), passwordEncoder.encode(userInput.getPassword()), userInput.getGenderId(), userInput.getBirthday(), userInput.getHeight());
